...
from friendli.cli.group import get_current_org, get_org_user_id_by_email
from friendli.client.group import GroupProjectClient
from friendli.client.project import ProjectClient, find_project_id
from friendli.client.user import UserClient, UserGroupProjectClient
...
def switch(
    ...
    :::info
    Your working project context is written at `./friendli/project` file in your home directory.
    :::
