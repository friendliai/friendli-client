...
class Completion(
    ...
    def create(
        ...
        Examples:
            The `options` argument gets a `V1CompletionOptions` object, which has the
            following schema.
            ...
            | `stop_tokens` | `Optional[List[TokenSequence]]` | `None` |
            ...
            - **stop_tokens**: Same as the above `stop` field, but receives token sequences instead of text phrases.
