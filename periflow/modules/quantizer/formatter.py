...
Int8QuantScaleInputTuple = Tuple[
    torch.Tensor, ModuleName, Optional[int], Optional[int]
]  # tuple of (weight in the shape of [OutDim, InDim], layer's module name, out_offset_start, out_offset_end)
